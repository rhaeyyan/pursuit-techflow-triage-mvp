...
export const DEMO_TICKETS: TriagedTicket[] = [
  {
    ...
    sub_category: 'database_outage',
    tags: ['technical', 'database', 'infrastructure', 'outage'],
    urgency: 'critical',
    urgency_score: 4,
    score: 98,
  ...
  },
  {
    ...
    issue_type: 'account',
    sub_category: 'auth_security',
    tags: ['account', 'security', 'api_keys'],
    urgency: 'critical',
    urgency_score: 4,
    score: 92,
  ...
  },
  {
    ...
    body: 'We were charged $24,000 twice on invoice #INV-2026-881. Our accounting department requires urgent correction and immediate refund confirmation. If not resolved today we will cancel our account.',
  ...
  },
  {
    ...
    urgency_score: 3,
    score: 75,
    reasons: ['Account request', 'Customer flagged as urgent'],
    status: 'new',
    assignee: null,
    confidence_source: 'llm',
  },
